...
#'
#' @description \code{rdm_IBD}: Reads genotype data for individuals in a population together with the geographical 
...
#'  geographical distances, and measuring the vertical distance from each pair to the fitted line. The fitted straight line 
#'  represents the combinations of genetic and geographical distances that are expected from IBD. A value of 2 means
...
#' @importFrom poppr diss.dist nei.dist rogers.dist reynolds.dist edwards.dist provesti.dist
